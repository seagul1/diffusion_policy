    ...
    def run(self, policy: BaseLowdimPolicy):
        ...
        for chunk_idx in range(n_chunks):
            ...
            while not done:
                ...
                # run policy
                with torch.no_grad():
                    # lowdim pusht CNN-based
                    # action_dict = {'action': tensor(B,Ta,Da)=(56,8,2), 'action_pred': tensor(B,T,Da)=(56,16,2),
                    #                'action_obs_pred': tensor(B,T,Do)=(56,8,20), 'obs_pred':tensor(B,T,Do)=(56,16,20)}
